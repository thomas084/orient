...
var LoginPage = /** @class */ (function () {
    function LoginPage(facebook, fireauth, router, toastController) {
    ...
    LoginPage.prototype.login = function () {
        ...
        this.fireauth.auth.signInWithEmailAndPassword(this.username, this.password)
            ...
            if (res.user) {
                ...
                _this.router.navigate(['/profiledata']);
            }
        })
            .catch(function (err) {
    ...
    LoginPage.prototype.popup = function () {
        this.pop = true;
    };
    LoginPage.prototype.popupcl = function () {
        this.pop = false;
    };
